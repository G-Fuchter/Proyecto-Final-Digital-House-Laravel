            ...
            <div class="top_bar row d-flex justify-content-between align-items-center pt-2">
                ...
                <nav class="user_nav">
                    <ul class="list-unstyled d-flex flex-row justify-content-between align-items-center list-unstyled">
                        <li class="px-2">
                            <a href=" login.php " class="small white ">Login</a>
                        </li>
                        <li class="px-2">
                            <a href="registro.php " class="small white ">Registro</a>
                        </li>
                    </ul>
                </nav>
            </div>
                    ...
                    <div class="collapse navbar-collapse ml-auto justify-content-center align-content-center align-items-center " id="toogleNavbar ">
                        <ul class="navbar-nav ">
                            ...
                            <li class="nav-item d-sm-block d-xs-none ">
                                <a class="navbar-brand " href="index.php ">¡Ñam!</a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link dark kappa-bold text-uppercase " href="# ">Comprar</a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link dark kappa-bold text-uppercase " href="# ">Faqs</a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link dark kappa-bold text-uppercase " href="# "><i class="fas fa-shopping-cart "></i></a>
                            </li>
                        </ul>
                    </div>
                </nav>
